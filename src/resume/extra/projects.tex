...
%---------------------------------------------------------
  \cventry
  	{Python Library for Worker-Pool Twitter Automation} % Job title
    {
			\href{https://github.com/TidalPaladin/twitlib}
			{Twitlib \faGithubSquare}
		}
    {Richardson, Texas} % Location
	...
	\begin{cvitems} % Description(s) of tasks/responsibilities
		\item {
			Implemented a Python library to simplify automation of Twitter
			activities.
		}
		\item {
			Packaged Docker deliverables using CircleCi workflows.
		}
	\end{cvitems}
	}
%---------------------------------------------------------
